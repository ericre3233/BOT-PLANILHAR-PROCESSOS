...
def RestituiçãoRural(contador, cont, bot: DesktopBot, self: DesktopBot, executation=None):
   ...
   while (contador < cont):    
                  ...
                  #finally:
                     # Certifique-se de liberar a tecla Ctrl após o uso
                  #   bot.kb_key_up("ctrl")    
